...
class AddEditFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val editVehicle: Vehicle? = arguments?.getParcelable("edit_vehicle")
        ...
        addButton.setOnClickListener{
            ...
            executor.execute{
                ...
                if(editVehicle!=null){
                    ...
                    val selectionArgs = arrayOf(editVehicle.id.toString())
                    context?.applicationContext?.contentResolver?.update(
                            Uri.parse("${VehicleProvider.URI_VEHICLE}/${editVehicle.id}"),
                            values,
                            selectionClause,
                            selectionArgs
                    )
